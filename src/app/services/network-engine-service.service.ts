...
export class NetworkEngineServiceService {
  ...
  // Remote Server
  mainUrl = "http://mobile.aviationgathering.ae/apis/";
  mainEventImagesUrl = "http://mobile.aviationgathering.ae/images/eventimages/";
  mainNewsImagesUrl = "http://mobile.aviationgathering.ae/images/newsimage/";
  mainUserProfileImageUrl = "http://mobile.aviationgathering.ae/images/profileimages/";

  mainUploadEventImagesAPI = "http://mobile.aviationgathering.ae/apis/uploadEventPhoto.php";
  mainUploadNewsImagesAPI = "http://mobile.aviationgathering.ae/apis/uploadNewsPhoto.php";
  mainUploadUserProfileImagesAPI = "http://mobile.aviationgathering.ae/apis/uploadUserProfileImage.php";
